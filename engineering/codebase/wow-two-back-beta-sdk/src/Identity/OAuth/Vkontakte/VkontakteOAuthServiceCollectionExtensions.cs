...
{
    /// <summary>Register Vkontakte as an OAuth provider. Pair with <c>AddCookieAuthentication</c> for the sign-in cookie.</summary>
    ...
    public static AuthenticationBuilder AddVkontakteAuthentication(this AuthenticationBuilder auth, string clientId, string clientSecret, Action<VkontakteAuthenticationOptions>? configure = null, params string[] scopes)
    {
