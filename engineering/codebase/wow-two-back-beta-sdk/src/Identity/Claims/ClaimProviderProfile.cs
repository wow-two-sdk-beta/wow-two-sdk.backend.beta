...
/// <param name="UserIdClaims">Priority-ordered sources for <see cref="NormalizedClaimTypeConstants.UserId"/>.</param>
/// <param name="EmailClaims">Priority-ordered sources for <see cref="NormalizedClaimTypeConstants.Email"/>.</param>
/// <param name="DisplayNameClaims">Priority-ordered sources for <see cref="NormalizedClaimTypeConstants.DisplayName"/>.</param>
/// <param name="UsernameClaims">Priority-ordered sources for <see cref="NormalizedClaimTypeConstants.Username"/>.</param>
