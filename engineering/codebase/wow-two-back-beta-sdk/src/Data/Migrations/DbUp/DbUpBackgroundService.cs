...
public sealed partial class DbUpBackgroundService : IHostedService
{
    private readonly DbUpOptions _options;
    private readonly ILogger<DbUpBackgroundService> _logger;

    /// <summary>Initializes a new instance.</summary>
    /// <param name="options">The DbUp runner options.</param>
    /// <param name="logger">The logger for run progress and failures.</param>
    public DbUpBackgroundService(DbUpOptions options, ILogger<DbUpBackgroundService> logger)
    {
        _options = options;
        _logger = logger;
    }
