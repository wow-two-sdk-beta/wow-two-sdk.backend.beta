...
/// <summary>Provider factory shortcuts for the supported DbUp engines.</summary>
/// <remarks>Sqlite is intentionally omitted — the dbup-sqlite engine takes a connection object rather than a string. Consumers targeting Sqlite should set <see cref="DbUpOptions.UpgradeEngineFactory"/> themselves, e.g. <c>cs =&gt; DeployChanges.To.SQLiteDatabase(new SharedConnection(new SQLiteConnection(cs)))</c>.</remarks>
public static class DbUpProviderFactory
{
