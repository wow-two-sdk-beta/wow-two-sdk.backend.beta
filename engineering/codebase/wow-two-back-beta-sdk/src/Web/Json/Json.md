...
- `AddControllersWithSdkJson(this IServiceCollection)` — `AddControllers()` + the SDK `JsonOptionsConstants.Default` preset (camelCase, null-ignoring, NodaTime, relaxed escaping) + camelCase string enums.
