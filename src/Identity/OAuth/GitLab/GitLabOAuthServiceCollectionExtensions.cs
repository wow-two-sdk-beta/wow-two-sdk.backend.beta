...
{
    /// <summary>Register GitLab as an OAuth provider. Pair with <c>AddCookieAuthentication</c> for the sign-in cookie.</summary>
    ...
    public static AuthenticationBuilder AddGitLabAuthentication(this AuthenticationBuilder auth, string clientId, string clientSecret, Action<GitLabAuthenticationOptions>? configure = null, params string[] scopes)
    {
