# WoW.Two.Sdk.Backend.Beta.Data.Migrations.Sql
...
| 3 | ✅ **DONE (2026-06-13)** — copied the 22 engine `.cs` to `src/Data/Migrations/Sql/`; namespace rewrite `SmartQr.Common.Persistence.Migrations` → `WoW.Two.Sdk.Backend.Beta.Data.Migrations.Sql`. (CLI/HTTP adapters not extracted yet — engine only.) |
