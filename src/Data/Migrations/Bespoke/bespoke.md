...
| 13 | SQLite dialect (drydock / secrets-vault adoption) | ship `SqliteMigrationDialect` + tests | ✅ **DONE (2026-06-18)** — dialect + `SqliteConnectionFactory` + 14 tests + web-freedom arch test; app rebases next |
