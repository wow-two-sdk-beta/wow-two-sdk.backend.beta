...
/// <summary>Defines read-write data access for an aggregate, keyed by <typeparamref name="TId"/> (<c>Create</c>/<c>Update</c>/<c>Delete</c> plus inherited <c>Get</c>).</summary>
